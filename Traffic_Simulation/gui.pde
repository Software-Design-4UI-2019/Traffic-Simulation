...
public void createGUI(){
  ...
  speedLimitSlider = new GSlider(this, 200, 25, 100, 40, 10.0);
  ...
  label2 = new GLabel(this, 305, 35, 90, 20);
  ...
  label3 = new GLabel(this, 506, 35, 90, 20);
  label3.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label3.setText("Traffic Density");
  label3.setTextBold();
  label3.setLocalColorScheme(GCScheme.PURPLE_SCHEME);
  label3.setOpaque(false);
  spawnRateSlider = new GSlider(this, 600, 25, 100, 40, 10.0);
